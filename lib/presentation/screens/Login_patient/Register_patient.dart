...
import 'package:graduation/presentation/screens/Login_patient/login_patientt.dart';
...
class RegisterPatient extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<LoginPatientCubit, LoginPatientState>(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    const Text("Welcome Back Patient",
                        style: TextStyle(
